...
NTHREADS = 48
exe = "/project/rrg-holt/k239nguy/bin/imsrg++"
...
mail_address = "k239nguy@uwaterloo.ca"
    ...
    for reference in ["%s%d" % (ELEM[Z], A)]:
        ...
        for e in [4]:
            for hw in [16]:
                ...
                ARGS["3bme"] = (
                    "/project/def-holt/shared/3bme/NO2B_ThBME_EM1.8_2.0_3NFJmax15_IS_hw16_ms18_36_24.stream.bin"
                )
                ARGS["LECs"] = "EM1.8_2.0"
                ...
                ARGS["Operators"] = (
                    "M0nu_F_3.54_none,M0nu_GT_3.54_none,M0nu_T_3.54_none"
                )
                ...
                logname = jobname + datetime.fromtimestamp(time()).strftime(
                    "_%y%m%d%H%M.log"
                )
                print(jobname)
